...
mod avx {
    ...
    pub unsafe fn bswap_u16(x: __m256i) -> __m256i {
        unsafe {
            let mask = _mm256_set_epi8(
                30, 31, 28, 29, 26, 27, 24, 25, 22, 23, 20, 21, 18, 19, 16, 17, 14, 15, 12, 13, 10,
    ...
    pub unsafe fn bswap_u32(x: __m256i) -> __m256i {
        unsafe {
            let mask = _mm256_set_epi8(
                28, 29, 30, 31, 24, 25, 26, 27, 20, 21, 22, 23, 16, 17, 18, 19, 12, 13, 14, 15, 8,
    ...
    pub unsafe fn bswap_u64(x: __m256i) -> __m256i {
        unsafe {
            let mask = _mm256_set_epi8(
                24, 25, 26, 27, 28, 29, 30, 31, 16, 17, 18, 19, 20, 21, 22, 23, 8, 9, 10, 11, 12,
